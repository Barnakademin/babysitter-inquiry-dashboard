...
export const mockInquiries: ClientInquiry[] = [
  ...
  },
  {
    ...
    needHelpWith: "Kulturutbyte & barnpassning",
    howOften: "6 d/v",
    numberOfKids: 1,
    formLanguage: "de",
  ...
  },
  {
    ...
    service: "emergency",
    languages: ["Swedish"],
    needHelpWith: "Akut barnpassning",
    howOften: "Vid behov",
    numberOfKids: 1,
    formLanguage: "sv",
    promoCode: null,
  ...
  },
  {
    ...
    service: "babysitting",
    languages: ["Swedish", "English"],
    needHelpWith: "Skollov",
    howOften: "Lov-perioder",
    numberOfKids: 2,
    formLanguage: "sv",
    promoCode: null,
  ...
  },
  {
    ...
    service: "au-pair",
    languages: ["Swedish", "English"],
    needHelpWith: "Internationellt utbyte",
    howOften: "Heltid",
    numberOfKids: 2,
    formLanguage: "en",
    promoCode: null,
